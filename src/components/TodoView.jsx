...
export const TodoView = ({ onStartFocus }) => {
    ...
    const dragPhaseListenersRef = useRef(null);
    ...
    const handleMouseDown = (e) => {
        ...
        const handleMouseMoveStart = (moveEvent) => {
            ...
            if (distance > 8) {
                ...
                dragPhaseListenersRef.current = null;
            }
        };
        ...
        dragPhaseListenersRef.current = {
            mousemove: handleMouseMoveStart,
            mouseup: handleMouseUpStart
        };
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            document.removeEventListener('mousemove', handleMouseMove);
            document.removeEventListener('mouseup', handleMouseUp);
            if (dragPhaseListenersRef.current) {
                document.removeEventListener('mousemove', dragPhaseListenersRef.current.mousemove);
                document.removeEventListener('mouseup', dragPhaseListenersRef.current.mouseup);
                dragPhaseListenersRef.current = null;
            }
        };
